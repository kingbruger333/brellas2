...
export const productType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description:
        "Добавьте фотографии товара. Первое фото будет главным на сайте. Фото можно менять местами. Лучше загружать квадратные фото 1:1, например 1200x1200 px, на светлом фоне.",
      type: "array",
      of: [
        {
          type: "image",
